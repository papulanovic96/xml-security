 ...
 *         &lt;element name="euchats" type="{http://www.megatravel.com/message}Message" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends User
{
    ...
    @OneToMany
    protected List<Message> euchats;
    ...
    /**
     * Gets the value of the euchats property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the euchats property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEuchats().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Message> getEuchats() {
        if (euchats == null) {
            euchats = new ArrayList<Message>();
        }
        return this.euchats;
    }
